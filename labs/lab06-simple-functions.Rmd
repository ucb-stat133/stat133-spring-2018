...
knitr::opts_chunk$set(echo = TRUE, fig.path = 'lab06-images/')
```
...
Write two functions `f()` and `g()` based on the previous equations. Include
roxygen comments to document your functions:
