---
title: "Lab 6: Simple Functions and Conditionals"
...
If you use an `Rmd` to write narrative and code for this practice, you must 
include a code chunk at the top of your file like the one in the following 
screen capture:

```{r error_true, out.width='80%', echo = FALSE, fig.align='center'}
...
stop knitting your `Rmd` if it encounters an error.
