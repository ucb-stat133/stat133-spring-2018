...
the pattern formed by `"ing"` which does not correspond to a file extension.
...
pattern by placing the dot `"\\."` at the beginning, and then grouping the four 
types of file extensions separated by `"|"`:
