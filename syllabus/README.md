...
## :one: R Survival Skills

+ :calendar: __Dates__: Jan 22-26:
+ :pushpin: __Topics__: Getting started with R, and comprehensive review of the RStudio workspace.
+ :book: __Lecture__
